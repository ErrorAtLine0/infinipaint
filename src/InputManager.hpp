...
NLOHMANN_JSON_SERIALIZE_ENUM(InputManager::KeyCodeEnum, {
    ...
    {InputManager::KEY_DRAW_UNSELECT, "Unselect Elements"},
    ...
    {InputManager::KEY_DRAW_TOOL_INKDROPPER, "Color Select Tool"},
    {InputManager::KEY_DRAW_TOOL_EDIT, "Edit Tool"},
