...
class SDLConan(ConanFile):
    ...
    def config_options(self):
        ...
        if self.settings.os != "Emscripten":
            del self.options.emscriptenPersistentPath
    ...
    def generate(self):
        ...
        if self.options.get_safe("emscriptenPersistentPath") and self.options.get_safe("emscriptenPersistentPath") != "":
            tc.cache_variables["SDL_EMSCRIPTEN_PERSISTENT_PATH"] = self.options.get_safe("emscriptenPersistentPath")
